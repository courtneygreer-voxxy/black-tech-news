        ...
        <div className="flex items-center justify-between py-6">
          ...
          <div className="flex items-center space-x-6">
            ...
            <div className="relative">
              ...
              >
                <Calendar className="w-5 h-5 text-gray-700 group-hover:text-red-600 transition-colors" />
                <span className="font-semibold text-gray-700 group-hover:text-black">
                  Summaries
                </span>
                <ChevronDown className={`w-4 h-4 text-gray-700 transition-transform ${summariesOpen ? 'rotate-180' : ''}`} />
              </button>
            ...
            {/* Social Media Links */}
            <div className="flex items-center space-x-4 border-l-2 border-gray-200 pl-6">
              <a
