...
export const metadata: Metadata = {
  ...
  description: 'Browse weekly digests of Black tech news, featuring top stories, trends, and AI-powered insights for students, professionals, and founders.',
  keywords: ['Black tech weekly digest', 'tech news summary', 'HBCU tech news', 'Black founders news', 'tech career opportunities'],
  openGraph: {
      ...
      <main className="min-h-screen bg-white">
        ...
        <div className="bg-black text-white py-16 border-b-4 border-red-600">
          <div className="max-w-4xl mx-auto px-8">
            <div className="flex items-center space-x-3 mb-6">
              ...
              <h1 className="text-5xl font-bold">Weekly Digests</h1>
            </div>
            <p className="text-gray-300 text-xl max-w-2xl">
              Every week, we curate the top Black tech stories with AI-powered insights and analysis
            </p>
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto px-8 py-12">
          ...
          <section className="mt-16 bg-gray-50 rounded-lg p-8 text-center">
            <h2 className="text-2xl font-bold mb-4">Never Miss a Digest</h2>
            <p className="text-gray-700 mb-6">
              New digests published every Monday morning. Get the latest Black tech news, startup funding, and career opportunities.
            </p>
            <Link
              href="/"
